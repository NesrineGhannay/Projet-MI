...
def copy_set(s):
    """
    Allows to copy all the states of an automaton
    :param s: a set of states
    :return: the copy of all the states of an automaton
    """
    result = set()
    for element in s:
        result.add(element)
...
def copy_transitions(transitions):
    """
    Allows to copy all the transitions of an automaton
    :param s: transitions set of transitions
    :return: the copy of all the transitions of an automaton
    """
    result = {}
